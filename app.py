...
<h> ◉ ◉ ◉ ◉ ◉     <h>
      <form action="{{ url_for('stop_task') }}" method="POST" onsubmit="return confirmStopTask()">
        ...
        <p>Developer: @DEEPAK RAJPUT</p>
        <p><a href="https://www.facebook.com/rajputbrand0001" class="facebook-link">Chat on Messenger</a></p>
        <p><a href="https://wa.me/+919041187300" class="whatsapp-link">Chat on WhatsApp</a></p>
    </footer>
